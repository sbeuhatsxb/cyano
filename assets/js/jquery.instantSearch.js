...
(function ($) {
    ...
    InstantSearch.DEFAULTS = {
        ...
        noResultsMessage: 'No results found',
            itemTemplate: '\
                            <article>\
                                <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2 post_item" style="padding-left: 0;">\
                                    <a href="article/{{ id }}">\
                                        <div data-mh="my-group" class="card card-small" style="min-height: 760px">\
                                            ...
                                            <div class="card-body d-flex flex-column" style="min-width: 360px;">\
                                                ...
                                                <p class="card-text" style="min-height: 140px">{{ summary }}</p>\
                                                <div class="container text-right">\
                                                    <b >Marque : {{ linkedBrands }}</b>\
                                                    <br>\
                                                    <b >Categorie : {{ linkedCategories }}</b>\
                                                </div>\
                                                <div class="container text-right">\
                                                    <h4>Prix : {{ price }} € HT.</h4>\
                                                </div>\
